 ...
 * (work in progress) Min, Max similairty thresholds can be set at query time (not index time). I.e. return the k closest items on the interval [0.9, 0.8] by cosine similarity from an input point. 
